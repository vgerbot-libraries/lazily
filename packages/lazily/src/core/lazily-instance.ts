...
export function isLazilyInstance(instance: unknown): instance is LazilyInstance<object> {
    return instance !== null && typeof instance === 'object' && IS_LAZILY in instance && !!instance[IS_LAZILY];
}

export function assertIsLazilyInstance(instance: unknown): asserts instance is LazilyInstance<object> {
